...
{
	$_obfuscate_DScDGgU0CgMDEisNEjQSWz8YIxAkJwE = -1;
	foreach ($zym_var_5 as $_obfuscate_DQYvGR8TNQUSJwQcBxlcJwsvFjVAOSI => $_obfuscate_DTQjFAcECQwjGRIIHkAWKhAFCAM3BAE ) 
	{
		if (!($_obfuscate_DTQjFAcECQwjGRIIHkAWKhAFCAM3BAE['field'] == $zym_var_4)) 
		{
			continue;
		}
		$_obfuscate_DScDGgU0CgMDEisNEjQSWz8YIxAkJwE = $_obfuscate_DQYvGR8TNQUSJwQcBxlcJwsvFjVAOSI;
		break;
	}
	return $_obfuscate_DScDGgU0CgMDEisNEjQSWz8YIxAkJwE;
}
?>