...
if ($operation == 'display') 
{
	...
	$list = array( array('groupname' => '无分组', 'membercount' => pdo_fetchcolumn('select count(*) from ' . tablename('sz_yi_member') . ' where uniacid=:uniacid and groupid=0 limit 1', array(':uniacid' => $_W['uniacid']))) );
...
else if ($operation == 'delete') 
{
	...
	pdo_update('sz_yi_member', array('groupid' => 0), array('uniacid' => $_W['uniacid']));
