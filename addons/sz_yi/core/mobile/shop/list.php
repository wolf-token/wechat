...
$args = array('pagesize' => 20, 'page' => $_GPC['page'], 'isnew' => $_GPC['isnew'], 'ishot' => $_GPC['ishot'], 'isrecommand' => $_GPC['isrecommand'], 'isdiscount' => $_GPC['isdiscount'], 'istime' => $_GPC['istime'], 'keywords' => $_GPC['keywords'], 'pcate' => $_GPC['pcate'], 'ccate' => $_GPC['ccate'], 'tcate' => $_GPC['tcate'], 'pcate1' => $_GPC['pcate1'], 'ccate1' => $_GPC['ccate1'], 'tcate1' => $_GPC['tcate1'], 'order' => $_GPC['order'], 'by' => $_GPC['by']);
if ($args['pcate']) 
{
