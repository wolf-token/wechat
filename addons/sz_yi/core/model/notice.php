...
class Sz_DYi_Notice 
{
	public function sendOrderMessage($orderid = '0', $delRefund = false) 
	{
		...
		if ($delRefund) 
		{
			$_obfuscate_DR8PJCUuORcIBjMvIysFAyoJOxYyGyI = array('退款', '退货退款', '换货');
			if (!empty($order['refundid'])) 
			{
				...
				{
					$msg = array( 'first' => array('value' => '您的' . $_obfuscate_DR8PJCUuORcIBjMvIysFAyoJOxYyGyI[$refund['rtype']] . '申请已经提交！', 'color' => '#4a5077'), 'orderProductPrice' => array('title' => '退款金额', 'value' => ($refund['rtype'] == 3 ? '-' : '¥' . $refund['applyprice'] . '元'), 'color' => '#4a5077'), 'orderProductName' => array('title' => '商品详情', 'value' => $goods . $orderpricestr, 'color' => '#4a5077'), 'orderName' => array('title' => '订单编号', 'value' => $order['ordersn'], 'color' => '#4a5077'), 'remark' => array('value' => "\r\n" . '等待商家确认' . $_obfuscate_DR8PJCUuORcIBjMvIysFAyoJOxYyGyI[$refund['rtype']] . '信息！', 'color' => '#4a5077') );
					...
					if (empty($usernotice['refund'])) 
					{
						...
						if ($refund['status'] == 3) 
						{
							$_obfuscate_DVw5KhgFCj4DCzkYJTYJFTwwKh4WIjI = iunserializer($refund['refundaddress']);
							$_obfuscate_DRsjWwotBi4qAzAhBD8rJRQhATYlHSI = '退货地址: ' . $_obfuscate_DVw5KhgFCj4DCzkYJTYJFTwwKh4WIjI['province'] . ' ' . $_obfuscate_DVw5KhgFCj4DCzkYJTYJFTwwKh4WIjI['city'] . ' ' . $_obfuscate_DVw5KhgFCj4DCzkYJTYJFTwwKh4WIjI['area'] . ' ' . $_obfuscate_DVw5KhgFCj4DCzkYJTYJFTwwKh4WIjI['address'] . ' 收件人: ' . $_obfuscate_DVw5KhgFCj4DCzkYJTYJFTwwKh4WIjI['name'] . ' (' . $_obfuscate_DVw5KhgFCj4DCzkYJTYJFTwwKh4WIjI['mobile'] . ')(' . $_obfuscate_DVw5KhgFCj4DCzkYJTYJFTwwKh4WIjI['tel'] . ') ';
							$msg = array( 'first' => array('value' => '您的' . $_obfuscate_DR8PJCUuORcIBjMvIysFAyoJOxYyGyI[$refund['rtype']] . '申请已经通过！', 'color' => '#4a5077'), 'orderProductPrice' => array('title' => '退款金额', 'value' => ($refund['rtype'] == 3 ? '-' : '¥' . $refund['applyprice'] . '元'), 'color' => '#4a5077'), 'orderProductName' => array('title' => '商品详情', 'value' => $goods . $orderpricestr, 'color' => '#4a5077'), 'orderName' => array('title' => '订单编号', 'value' => $order['ordersn'], 'color' => '#4a5077'), 'remark' => array('value' => "\r\n" . '请您根据商家提供的退货地址将商品寄回！' . $_obfuscate_DRsjWwotBi4qAzAhBD8rJRQhATYlHSI . '', 'color' => '#4a5077') );
							if (!empty($tm['refund']) && empty($usernotice['refund'])) 
							{
								m('message')->sendTplNotice($openid, $tm['refund'], $msg, $detailurl);
								return;
							...
							if (empty($usernotice['refund'])) 
							{
								...
								if ($refund['status'] == 5) 
								{
									...
									{
										$_obfuscate_DQk7Gxw7JBMzLjwOKiwWNyEKBysaPQE = iunserializer($order['address_send']);
										if (!is_array($_obfuscate_DQk7Gxw7JBMzLjwOKiwWNyEKBysaPQE)) 
										{
											$_obfuscate_DQk7Gxw7JBMzLjwOKiwWNyEKBysaPQE = iunserializer($order['address']);
											if (!is_array($_obfuscate_DQk7Gxw7JBMzLjwOKiwWNyEKBysaPQE)) 
											{
												$_obfuscate_DQk7Gxw7JBMzLjwOKiwWNyEKBysaPQE = pdo_fetch('select id,realname,mobile,address,province,city,area from ' . tablename('sz_yi_member_address') . ' where id=:id and uniacid=:uniacid limit 1', array(':id' => $order['addressid'], ':uniacid' => $_W['uniacid']));
											}
										}
									}
									if (empty($_obfuscate_DQk7Gxw7JBMzLjwOKiwWNyEKBysaPQE)) 
									{
										return;
									}
									$msg = array( 'first' => array('value' => '您的换货物品已经发货！', 'color' => '#4a5077'), 'keyword1' => array('title' => '订单内容', 'value' => '【' . $order['ordersn'] . '】' . $goods, 'color' => '#4a5077'), 'keyword2' => array('title' => '物流服务', 'value' => $refund['rexpresscom'], 'color' => '#4a5077'), 'keyword3' => array('title' => '快递单号', 'value' => $refund['rexpresssn'], 'color' => '#4a5077'), 'keyword4' => array('title' => '收货信息', 'value' => '地址: ' . $_obfuscate_DQk7Gxw7JBMzLjwOKiwWNyEKBysaPQE['province'] . ' ' . $_obfuscate_DQk7Gxw7JBMzLjwOKiwWNyEKBysaPQE['city'] . ' ' . $_obfuscate_DQk7Gxw7JBMzLjwOKiwWNyEKBysaPQE['area'] . ' ' . $_obfuscate_DQk7Gxw7JBMzLjwOKiwWNyEKBysaPQE['address'] . '收件人: ' . $_obfuscate_DQk7Gxw7JBMzLjwOKiwWNyEKBysaPQE['realname'] . ' (' . $_obfuscate_DQk7Gxw7JBMzLjwOKiwWNyEKBysaPQE['mobile'] . ') ', 'color' => '#4a5077'), 'remark' => array('value' => "\r\n" . '我们正加速送到您的手上，请您耐心等候。', 'color' => '#4a5077') );
				...
				else 
				{
					...
					$_obfuscate_DRsjWwotBi4qAzAhBD8rJRQhATYlHSI = '退货地址: ' . $_obfuscate_DVw5KhgFCj4DCzkYJTYJFTwwKh4WIjI['province'] . ' ' . $_obfuscate_DVw5KhgFCj4DCzkYJTYJFTwwKh4WIjI['city'] . ' ' . $_obfuscate_DVw5KhgFCj4DCzkYJTYJFTwwKh4WIjI['area'] . ' ' . $_obfuscate_DVw5KhgFCj4DCzkYJTYJFTwwKh4WIjI['address'] . ' 收件人: ' . $_obfuscate_DVw5KhgFCj4DCzkYJTYJFTwwKh4WIjI['name'] . ' (' . $_obfuscate_DVw5KhgFCj4DCzkYJTYJFTwwKh4WIjI['mobile'] . ')(' . $_obfuscate_DVw5KhgFCj4DCzkYJTYJFTwwKh4WIjI['tel'] . ') ';
					goto label275;
					label275: $msg = array( 'first' => array('value' => '您的' . $_obfuscate_DR8PJCUuORcIBjMvIysFAyoJOxYyGyI[$refund['rtype']] . '申请已经通过！', 'color' => '#4a5077'), 'orderProductPrice' => array('title' => '退款金额', 'value' => '¥' . $refund['applyprice'] . '元', 'color' => '#4a5077'), 'orderProductName' => array('title' => '商品详情', 'value' => $goods . $orderpricestr, 'color' => '#4a5077'), 'orderName' => array('title' => '订单编号', 'value' => $order['ordersn'], 'color' => '#4a5077'), 'remark' => array('value' => "\r\n" . '请您根据商家提供的退货地址将商品寄回！' . $_obfuscate_DRsjWwotBi4qAzAhBD8rJRQhATYlHSI . '', 'color' => '#4a5077') );
					m('message')->sendTplNotice($openid, $tm['refund'], $msg, $detailurl);
					return;
					m('message')->sendCustomNotice($openid, $msg, $detailurl);
					return;
	...
	public function sendMemberLogMessage($log_id = '') 
	{
		...
		elseif (($log_info ['type'] == 1) && ($log_info ['status'] == 0)) 
		{
