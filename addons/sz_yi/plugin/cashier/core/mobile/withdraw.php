...
else if (($operation == 'submit') && $_W['ispost']) 
{
	...
	$_var_157 = array( 'keyword1' => array('value' => '收银台提现成功通知', 'color' => '#73a68d'), 'keyword2' => array('value' => '【商户名称】' . $cashier_stores['name'], 'color' => '#73a68d'), 'remark' => array('value' => '恭喜,您的提现申请已经成功提交!') );
