...
if (!class_exists('YunpayModel')) {
	class YunpayModel extends PluginModel
	{
		...
		{
			global $_W;
			$_var_0 = pdo_fetch('select * from ' . tablename('sz_yi_sysset') . ' where uniacid=:uniacid limit 1', array(
				':uniacid' => $_W['uniacid']
			));
		...
		public function yunpay_build($_var_6, $_var_3 = array(), $_var_7 = 0, $_var_8 = '')
		{
			...
			$_var_17 = "";
			$_var_18 = array(
				'partner' => trim($_var_3['partner']),
				'seller_email' => $_var_3['account'],
				'out_trade_no' => $_var_12,
				'subject' => $_var_13,
				'total_fee' => $_var_14,
				'body' => $_var_15,
				'nourl' => $_var_10,
