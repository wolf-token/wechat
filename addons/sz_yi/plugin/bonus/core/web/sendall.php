...
if (!empty($_POST)) 
{
	...
	$log = array('uniacid' => $_W['uniacid'], 'money' => $totalmoney, 'status' => 1, 'ctime' => time(), 'sendmonth' => $set['sendmonth'], 'paymethod' => $set['paymethod'], 'sendpay_error' => $sendpay_error, 'isglobal' => 1, 'utime' => $daytime, 'send_bonus_sn' => $send_bonus_sn, 'total' => $total);
